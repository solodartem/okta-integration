...
<form action="/okta-integration/opened/redirectToWebSSO" method="GET">
    ...
    <input style="width: 757px; height: 70px" type="text" width="100%" name="metadataURL" value="https://dev-245923.oktapreview.com/app/exka3a4igdwiBfp3V0h7/sso/saml/metadata"/>
    <br>
